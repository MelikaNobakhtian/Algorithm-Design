...
namespace suffix_array
{
    class Program
    {
        ...
        public static long[] Sortdoubled(int textlength, long[] orders, long[] classes, int l)
        {
        ...
        public static long[] ComputeClasses(string text, long[] orders)
        {
            int len = text.Length;
        ...
        public static long[] SortCharacters(string text)
        {
            int len = text.Length;
